...
public class EventAdapterAdmin extends RecyclerView.Adapter<EventAdminViewHolder> {

    private Context context;
    private List<EventDataClass> dataList;

    public EventAdapterAdmin(Context context, List<EventDataClass> dataList) {
    ...
    @NonNull
    @Override
    public EventAdminViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_item, parent, false);
        return new EventAdminViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull EventAdminViewHolder holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, DetailEventAdmin.class);
...
class EventAdminViewHolder extends RecyclerView.ViewHolder{
    ...
    public EventAdminViewHolder(@NonNull View itemView) {
        super(itemView);
