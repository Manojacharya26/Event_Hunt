...
public class MyOrder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       UserID=FirebaseAuth.getInstance().getCurrentUser().getUid();
        ...
        adapter = new BookEventAdapter(MyOrder.this, dataList);
        recyclerView_event.setAdapter(adapter);
        databaseReference = FirebaseDatabase.getInstance().getReference("Booked Event").child(UserID);
        dialog.show();
    ...
    public void artist(){
     ...
     /*   AlertDialog.Builder builder = new AlertDialog.Builder(getApplicationContext());
        ...
        databaseReference2 = FirebaseDatabase.getInstance().getReference("Booked Artist").child(UserID);
    ...
    public void venue(){
     ...
     /*   AlertDialog.Builder builder = new AlertDialog.Builder(getApplicationContext());
        ...
        databaseReference3 = FirebaseDatabase.getInstance().getReference("Booked Venue").child(UserID);
